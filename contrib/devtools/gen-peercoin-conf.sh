...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/Brycecoin.conf}
...
then
  ...
  echo -e "To safely generate a Brycecoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example Brycecoin.conf file in share/examples/'
...
##
## Brycecoin.conf configuration file.
## Generated by contrib/devtools/gen-Brycecoin-conf.sh.
##
...
# parse the output from Brycecoind --help
