...
BOOST_AUTO_TEST_CASE(MempoolAncestryTests)
{
    ...
    // [tx1].0 <- [tx2]
    //
    CTransactionRef tx2 = make_tx(/*output_values=*/{495 * scott, 5 * COIN}, /*inputs=*/{tx1});
    ...
    // [tx1].0 <- [tx2].0 <- [tx3]
    //
    CTransactionRef tx3 = make_tx(/*output_values=*/{290 * scott, 200 * scott}, /*inputs=*/{tx2});
    ...
    //              \---1 <- [tx4]
    //
    CTransactionRef tx4 = make_tx(/*output_values=*/{290 * scott, 250 * scott}, /*inputs=*/{tx2}, /*input_indices=*/{1});
