...
{
    switch (unit) {
    case Unit::BTC: return QString("BRY");
    case Unit::mBTC: return QString("mBRY");
    case Unit::uBTC: return QString::fromUtf8("μBRY");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Brycecoins");
    case Unit::mBTC: return QString("Milli-Brycecoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Brycecoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
